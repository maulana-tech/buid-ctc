                ...
                <div className="grid gap-4 md:grid-cols-2 md:gap-6 lg:gap-12">
                    ...
                    <div className="space-y-6 lg:space-y-12">
                        <p className="text-muted-foreground text-balance text-lg">
                            CreditPass reads your borrow, repay, and liquidation events from Aave V3 on Ethereum, verifies each one on Creditcoin through the Attestcoin Protocol, and turns them into a non-transferable score. That score sets how much you can borrow with nothing posted as collateral.
                        </p>
