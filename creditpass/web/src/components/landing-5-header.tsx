    ...
    return (
        <header>
            <nav
                ...
                data-scrolled={isScrolled && 'true'}
                className={cn('max-lg:data-[state=active]:bg-background fixed top-0 z-20 w-full max-lg:data-[state=active]:bottom-0', 'data-[scrolled=true]:bg-background data-[scrolled=true]:border-b')}>
                <div className="mx-auto max-w-7xl px-6">
                    <div className="lg:in-data-[scrolled=true]:py-3 relative flex flex-wrap items-center justify-between gap-6 py-4 lg:gap-0 lg:py-6">
                        ...
                        <div className="in-data-[state=active]:block lg:in-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end max-lg:space-y-8 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6">
                            ...
                            <div className="flex w-full flex-col space-y-3 sm:flex-row sm:items-center sm:gap-3 sm:space-y-0 md:w-fit">
                                ...
                                <Button
                                    nativeButton={false}
                                    render={<Link href="#how-it-works">Read the docs</Link>}
                                    variant="outline"
                                    size="sm"
                                />
                                <Button
                                    nativeButton={false}
                                    render={<Link href="/app">Check my score</Link>}
                                    size="sm"
                                />
                            </div>
                        </div>
